...
import networks_resized
import losses

sys.path.append('/home/ruihao/Learn-tissue-distribution/code/ext/neuron')
...
#    name_list = np.load('name_list.npy')
    atlas_vol = scipy.io.loadmat('/home/workspace1/deformation_generator/circle_toy/vae_voxelmorph/test_translation/data/source/circle.mat')['data_all']
#    atlas_vol = np.zeros((64,64))
#    atlas_vol[:311,:256,:256] = atlas_vol_raw[:311,:256,:256]
#    atlas_vol = transform.resize(atlas_vol,(64,64,64))  #160,128,128
    atlas_vol = atlas_vol[np.newaxis,:,:,np.newaxis]
    vol_size = atlas_vol.shape[1:-1]
    # prepare data files
    # train_vol_names is the single template to be deformed
    # atlas_vol_names is the tissue distribution images
    train_vol_names = os.listdir('/home/workspace1/deformation_generator/circle_toy/vae_voxelmorph/test_translation/data/source')
    atlas_vol_names = os.listdir('/home/workspace1/deformation_generator/circle_toy/vae_voxelmorph/test_translation/data/target255')
    assert len(train_vol_names) > 0, "Could not find any training data"
#    for i in range(5001):
#        train_vol_names = glob.glob(os.path.join("/home/ruihao/Learn-tissue-distribution/code/HCP-deform/src/gen_warp_circle_64/circle_{}.mat".format(i)))
...
#    nf_dec = [32,32,32,32,16,3]
    ...
    with tf.device(gpu):
        ...
        model = networks_resized.cvae(vol_size, bidir=bidir)
        ...
        if bidir:
            ...
            model_losses = [losses.NCC().loss, loss_class.kl_loss]#loss_class.kl_loss]
            loss_weights = [1, 1]
    ...
    atlas_vol_bs = datagenerators.example_gen_alt(atlas_vol_names,batch_size=batch_size)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--steps_per_epoch", type=int,
                        dest="steps_per_epoch", default=30,
